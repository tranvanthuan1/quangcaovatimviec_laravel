	...
	<!--<div id="small-dialog1" class="mfp-hide">
		<div class="contact-form1">
			<div class="contact-w3-agileits">-->
				<form action="{{URL::to('/authregister')}}" method="POST">
					 @csrf
					 <?php
						$error = Session::get('errorr');
						if($error){
							echo $error;
					...
					<h3>Thông tin đăng nhập</h3>
						...
						<div class="form-sub-w3ls">
							<input placeholder="Tên tài khoản" name="UserNguoiDung" type="text" required="">
						...
						<div class="form-sub-w3ls">
							<input placeholder="Mật khẩu"  type="password" name="MkNguoiDung" required="">
							<div class="icon-agile">
						...
						<div class="form-sub-w3ls">
							<input placeholder="Nhập lại mật khẩu" name="MkNguoiDung_confirmation" type="password" required="">
							<div class="icon-agile">
								<i class="fa fa-unlock-alt" aria-hidden="true"></i>
							</div>
						...
						<div class="form-sub-w3ls">
							<input placeholder="Họ và tên" name="TenNguoiDung" type="text" required="">
						</div>
						<div class="form-sub-w3ls">
							<input placeholder="Giới tính" name="GioiTinh" type="text" required="">
						</div>
						<div class="form-sub-w3ls">
							<input placeholder="Số điện thoại" name="SoDt"  type="text" required="">
						</div>
						<div class="form-sub-w3ls">
							<input placeholder="Năm sinh" name="NamSinh"  type="text" required="">
						</div>
						<div class="form-sub-w3ls">
						...
						<div class="form-sub-w3ls">
							<input placeholder="Link CV" name="Cv" type="text" required="">
						</div>
					...
					<center><a href="{{URL::to('/authlogin')}}">Quay về đăng nhập</a></center>
				</form>
			<!--</div>
		</div>	
	</div>-->
