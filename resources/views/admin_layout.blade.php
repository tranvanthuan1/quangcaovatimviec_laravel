        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/duyetnguoitimviec')}}">Phê duyệt tài khoản ứng viên</a></li>
						<li><a href="{{URL::to('/duyetnhatuyendung')}}">Phê duyệt tài khoản nhà tuyển dụng</a></li>
                        <li><a href="{{URL::to('/duyetbaidang')}}">Phê duyệt bài đăng</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-post')}}">Thêm bài đăng</a></li>
                        <li><a href="{{URL::to('/all-post')}}">Danh sách bài đăng</a></li>
                    </ul>
                </li>
